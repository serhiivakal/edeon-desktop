...
def run_card(endpoint: str = None) -> None:
    """Compiles the structured DataCard YAML and generates the release manifest for algae growth EC50."""
    ...
    inclusion = [
        "In vivo Algae growth EC50 toxicity records only",
        "Endpoint ∈ {EC50, ErC50, EbC50}",
        "Effect = GRO (growth) or POP (population)",
        "Test duration = 72h (64.8h - 79.2h)",
        "Species restricted to Raphidocelis subcapitata, Selenastrum capricornutum, Chlorella vulgaris, Desmodesmus subspicatus",
        "Exposure = aquatic"
    ]
    
    exclusion = [
        "Mixtures, formulations, or records with missing structures",
        "Non-aquatic exposure routes",
    ...
    card = DataCard(
        ...
        splits=splits_info,
        known_biases=biases,
        intended_use="Training and benchmarking Tier-1 QSAR algae growth EC50 prediction models.",
