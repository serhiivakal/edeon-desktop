...
def run_card(endpoint: str = None) -> None:
    """Compiles the structured DataCard YAML and generates the release manifest for daphnia acute EC50."""
    ...
    inclusion = [
        "In vivo Daphnia acute EC50 toxicity records only",
        "Effect = IMM (immobilisation) or MOR (mortality)",
        "Test duration = 48h (45.6h - 50.4h)",
        "Species restricted to Daphnia magna (primary) and Daphnia pulex (secondary)",
        "Exposure = aquatic"
    ]
    ...
    card = DataCard(
        ...
        splits=splits_info,
        known_biases=biases,
        intended_use="Training and benchmarking Tier-1 QSAR Daphnia acute EC50 prediction models.",
