...
def run_split(endpoint: str = None) -> None:
    """Creates scaffold, random, and chronological time splits for BCF dataset."""
    endpoint = "bcf"
    ...
    # 3. Time Split (70/15/15) - default not available since year is not present in raw OPERA SDF files
    time_res = time_split(
        df_curated,
