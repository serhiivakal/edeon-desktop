...
class RatLD50_T2(ModelBackend):
    _ENDPOINT = Endpoint.RAT_ACUTE_ORAL_LD50
    ...
    def metadata(self) -> ModelCard:
        return ModelCard(
            model_id=self.model_id(),
            name="Edeon Legacy Rat LD50 (LogP-based)",
            version=self._VERSION,
            tier=2,
            endpoint=self._ENDPOINT.value,
            description=(
                "Tier-2 baseline screening estimate of mammalian acute oral LD50 "
            ...
            not_intended_for=[
                ...
                "Replacement of OECD 401/420/423 testing",
            ],
