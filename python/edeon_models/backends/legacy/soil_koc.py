...
class SoilKoc_T2(ModelBackend):
    _ENDPOINT = Endpoint.SOIL_KOC
    ...
    def metadata(self) -> ModelCard:
        return ModelCard(
            model_id=self.model_id(),
            name="Edeon Legacy Soil Koc (LogP-based)",
            version=self._VERSION,
            tier=2,
            endpoint=self._ENDPOINT.value,
            description=(
                "Tier-2 baseline screening estimate of soil organic carbon partition coefficient "
            ...
            not_intended_for=[
                ...
                "Replacement of OECD 106/121 testing",
            ],
