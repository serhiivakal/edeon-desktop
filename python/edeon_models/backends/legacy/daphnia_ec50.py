...
class DaphniaEC50_T2(ModelBackend):
    _ENDPOINT = Endpoint.DAPHNIA_ACUTE_EC50
    ...
    def metadata(self) -> ModelCard:
        return ModelCard(
            model_id=self.model_id(),
            name="Edeon Legacy Daphnia EC50 (LogP-based)",
            version=self._VERSION,
            tier=2,
            endpoint=self._ENDPOINT.value,
            description=(
                "Tier-2 baseline screening estimate of Daphnia magna acute EC50 "
