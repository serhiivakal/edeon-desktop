...
class FishLC50_T2(ModelBackend):
    _ENDPOINT = Endpoint.FISH_ACUTE_LC50
    ...
    def metadata(self) -> ModelCard:
        return ModelCard(
            model_id=self.model_id(),
            name="Edeon Legacy Fish LC50 (LogP-based)",
            version=self._VERSION,
            tier=2,
            endpoint=self._ENDPOINT.value,
            description=(
                "Tier-2 baseline screening estimate of fish acute LC50 "
            ...
            not_intended_for=[
                ...
                "Replacement of OECD 203 testing",
            ],
