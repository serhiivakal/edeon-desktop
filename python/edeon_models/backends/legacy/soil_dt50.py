...
class SoilDT50_T2(ModelBackend):
    _ENDPOINT = Endpoint.SOIL_DT50
    ...
    def metadata(self) -> ModelCard:
        return ModelCard(
            model_id=self.model_id(),
            name="Edeon Legacy Soil DT50 (LogP-based)",
            version=self._VERSION,
            tier=2,
            endpoint=self._ENDPOINT.value,
            description=(
                "Tier-2 baseline screening estimate of soil degradation half-life "
            ...
            not_intended_for=[
                ...
                "Replacement of OECD 307 testing",
            ],
