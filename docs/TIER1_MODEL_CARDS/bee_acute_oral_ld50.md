# Model Card: Edeon Tier-1 Reference Bee Acute Oral Ld50 (Classification)

**Model ID:** `t1_bee_acute_oral_ld50_v1.0_cls` | **Version:** `v1.0_cls`
...
- **F1:** 0.2353
- **ECE:** 0.1191
- **Conformal Coverage (95%):** 100.0%
- **Mean Set Size:** 1.87

## Applicability Domain
- **Method:** Tanimoto 5-NN Morgan Fingerprint
- **In-Domain Distance Threshold (95%):** 0.8633
- **Borderline Distance Threshold (99%):** 0.9037
